...
two = np.array([[12,23,34,45],[98,65,23,64]])
...
# # two dimensional
two = np.insert(two,2,[23,45,46,474],axis=0)
print(two)
...
# new2 = np.split(two,2)                # error because two is 2D array and spliting is not possible in 2D array
# print(new2)

# new3= np.split(two,5)                 # error because spliting is not possible in 2D array with more than 2 parts
# print(new3)

new4 = np.array_split(two,2)            # spliting with unequal parts
print(new4)


new5 = np.hsplit(two,2)                # horizontal spliting
print(new5)                             # error because spliting is not possible in 2D array
                        ...
                        # some built in funstions
        # find missing values in an array
missing = np.isnan(one)                # returns boolean array with True for missing values
print(missing)


        # find unique values in an array
unique_values = np.unique(one)         # returns unique values in an array                      
print(unique_values)


        # find infiny values in an array
infiny= np.isinf(two)                # returns boolean array with True for infinite values
print(infiny)


        # replace values in an array
np.nan_to_num(one, copy=False, nan=0, posinf=None, neginf=None)  # replace NaN with 0 , positive infinity with None, and negative infinity with None
print(one)
